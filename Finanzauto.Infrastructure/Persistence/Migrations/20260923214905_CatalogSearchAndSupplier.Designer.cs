...
namespace Finanzauto.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923214905_CatalogSearchAndSupplier")]
    partial class CatalogSearchAndSupplier
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Finanzauto.Domain.Entities.Category", b =>
                {
                    ...
                    b.Property<string>("NormalizedName")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasComputedColumnSql("upper(btrim(\"CategoryName\"))", true);
            ...
            modelBuilder.Entity("Finanzauto.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("SearchName")
                        ...
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasComputedColumnSql("upper(\"ProductName\")", true);
                    ...
                    b.HasIndex("Active", "UnitPrice", "ProductId");
